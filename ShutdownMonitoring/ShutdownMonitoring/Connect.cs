...
namespace ShutdownMonitoring
{
    public class Connect
    {
        ...
        private string strConnection = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=\\mxtswtjnts\Groups\GRP Tijuana Departments\Plastics\2015 Plastics DB\Shutdown Monitoring\Shutdown_Monitoring.accdb;Jet OLEDB:Database Password=Baxter09.";
